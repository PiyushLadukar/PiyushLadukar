...
## 🕷️ About Me
🚀 Software Developer focused on **Spring Boot, Android & scalable backend systems**  
⚡ Built secure finance platforms, IoT automation & API-driven apps  
📍 Nagpur, India  
...
## 🧩 Top Projects
🕸️ **Bank Management System** — Spring Boot, JWT, RBAC  
🕷️ **IoT Attendance System** — Arduino + RFID + Android  
🌦️ **Weather Forecast App** — Java + API + Material UI  
